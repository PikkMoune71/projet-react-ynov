  ...
  return (
    <div className="contentContainer">
      ...
      <div className='img-container'>
        {props.tweetParam != null && props.tweetParam.includes != null && props.tweetParam.includes.media != null ? props.tweetParam.includes.media.map((object, i) => object.type === "photo" ? <div><img key={i} src={object.url} alt="" /></div> : "") : ""}
      </div>
